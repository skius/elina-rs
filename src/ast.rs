        ...
        unsafe {
            ...
            let inf_bound = match elina_scalar_infty(inf) {
                ...
                _ => {
                    ...
                    let str_ptr = __gmpq_get_str(null_mut(), 10, &inf);
                    let sign = if *str_ptr as u8 == *"-".as_ptr() {
                        -1
                    } else {
                        1
                    };
                    ...
                    Bound::Num(((result_enum as f64) / (result_denom as f64)).ceil() as i64 * sign)
                }
            };
            ...
            let sup_bound = match elina_scalar_infty(sup) {
                ...
                _ => {
                    ...
                    let str_ptr = __gmpq_get_str(null_mut(), 10, &sup);
                    let sign = if *str_ptr as u8 == *"-".as_ptr() {
                        -1
                    } else {
                        1
                    ...
                    Bound::Num(((result_enum as f64) / (result_denom as f64)).floor() as i64 * sign)
                }
            };
